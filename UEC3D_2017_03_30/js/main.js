...
// loading开始
    ...
    var arr=[
        ...
        {src:str+"/ceng2.png"},
        {src:str+"/ceng3.png"},
        {src:str+"/closeCeng.png"},
        {src:str+"/hand.png"},
        {src:str+"/hand2.png"},
        {src:str+"/handCircle.png"},
        {src:str+"/handCircle2.png"},
        {src:str+"/handLine.png"},
        {src:str+"/handText.png"},
        {src:str+"/loading.png"},
        {src:str+"/logo.png"},
        {src:str+"/musicOff.png"},
        {src:str+"/musicOn.png"},
        {src:str+"/net.png"},
        {src:str+"/page11.png"},
        {src:str+"/page121.png"},
        ...
        {src:str+"/page62.png"},
        {src:str+"/page63.png"},
        {src:str+"/pageLine2.png"},
        {src:str+"/pageLine3.png"},
        {src:str+"/pageLine4.png"},
        {src:str+"/pageLine5.png"},
        {src:str+"/shadow.png"},
        {src:str+"/shadow.png"},
        {src:strVideo+"/yiti.jpg"},
        {src:str+"/bubbleMoHu.png"},
        {src:str+"/wShare.png"},
        {src:str+"/textBottom.png"}
    ];
    var loadingImgI=0;
    ...
    bottleImg.src=str+"/bubble.png";
    bubbleImg.src=str+"/bubble.png";
    bubbleImg2.src=str+"/bubble2.png";
    bubbleImg3.src=str+"/bg.jpg";
