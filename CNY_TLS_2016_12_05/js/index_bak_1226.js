var HyFn = (function(window, undefined){
	...
	var initIMG4 = {w:10, maxH:514, minH:460, maxT:200, count:144};

	var initIMG_hill = [
		{x:583, maxH:0, minH:0, maxT:1000, sign: 1, id:'hill_8', blankS:400, blankE:-770},
		{x:1062, maxH:0, minH:0, maxT:1000, sign: 1, id:'hill_7', blankS:100, blankE:-500},
		{x:937, maxH:0, minH:0, maxT:1000, sign: 1, id:'hill_6', blankS:100, blankE:-500},
		{x:789, maxH:0, minH:0, maxT:1000, sign: 1, id:'hill_5', blankS:100, blankE:-500},
		{x:333, maxH:0, minH:0, maxT:1000, sign: 1, id:'hill_4', blankS:100, blankE:-719},
		{x:256, maxH:0, minH:0, maxT:1000, sign: 1, id:'hill_1', blankS:240, blankE:-587},
		{x:-20, maxH:0, minH:0, maxT:1000, sign: 1, id:'hill_2', blankS:410, blankE:-646}
	];
	...
	var initIMG_hill1 = [
		{x:256, maxH:20, minH:10, maxT:400, sign: 1, id:'hill_1',noBlank:true},
		{x:333, maxH:20, minH:10, maxT:400, sign: 1, id:'hill_4',noBlank:true},
		{x:789, maxH:20, minH:10, maxT:400, sign: 1, id:'hill_5',noBlank:true},
		{x:937, maxH:20, minH:10, maxT:400, sign: 1, id:'hill_6',noBlank:true}
	];

	var stage, container, images=images||{}, H=window.innerHeight, initX = 0, pixi, ticks, slogan=false, 
		sloX=0, mus, bg, SPEED=6, toVideo=false, SKIP=false, SW=screen.width;
	...
	return {
		init: function(){
			...
			// $('.music').on(evStart, function(){
			// 	$(this).hasClass('pause')
			// 	? ($(this).removeClass('pause'),createjs.Sound.volume = 1)
			// 	: ($(this).addClass('pause'),createjs.Sound.volume = 0);
			// });
			// alert(SW);
			if(SW==414) {
